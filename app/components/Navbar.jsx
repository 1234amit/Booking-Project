  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-200">
      <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        <Link href="/" className="text-xl font-semibold text-indigo-600">BookNest</Link>
        <div className="hidden md:flex items-center gap-6">
          <CustomLink href="/providers" className="text-gray-700 hover:text-indigo-600">Providers</CustomLink>
          ...
          <CustomLink href="/auth/login" className="rounded-lg bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700">Sign in</CustomLink>
        </div>
